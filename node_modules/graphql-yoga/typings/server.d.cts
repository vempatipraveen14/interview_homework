...
import type { ServerAdapter, ServerAdapterBaseObject, ServerAdapterInitialContext, ServerAdapterOptions, ServerAdapterRequestHandler } from '@whatwg-node/server';
import { useCORS } from '@whatwg-node/server';
import type { ParamsHandler, Plugin } from './plugins/types.cjs';
import type { GraphiQLOptions, GraphiQLOptionsOrFactory } from './plugins/use-graphiql.cjs';
import type { ParserAndValidationCacheOptions } from './plugins/use-parser-and-validation-cache.cjs';
import type { YogaSchemaDefinition } from './plugins/use-schema.cjs';
import type { LandingPageRenderer } from './plugins/use-unhandled-route.cjs';
import type { FetchAPI, GraphQLParams, YogaInitialContext, YogaMaskedErrorOpts } from './types.cjs';
/**
...
export declare class YogaServer<TServerContext extends Record<string, any>, TUserContext extends Record<string, any>> implements ServerAdapterBaseObject<TServerContext> {
    ...
    getResultForParams: ({ params, request, }: {
        ...
        request: Request;
    }, context: TServerContext) => PromiseOrValue<AsyncIterable<ExecutionResult<import("graphql/jsutils/ObjMap.js").ObjMap<unknown>, import("graphql/jsutils/ObjMap.js").ObjMap<unknown>>> | AsyncIterable<import("@graphql-tools/utils").ExecutionResult<any, any>> | ExecutionResult<import("graphql/jsutils/ObjMap.js").ObjMap<unknown>, import("graphql/jsutils/ObjMap.js").ObjMap<unknown>> | import("@graphql-tools/utils").ExecutionResult<any, any>>;
