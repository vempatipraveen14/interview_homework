...
const is_response_js_1 = require("./utils/is-response.js");
...
class YogaServer {
    ...
    parseRequest = (request, serverContext) => {
        ...
        return (0, promise_helpers_1.handleMaybePromise)(() => (0, promise_helpers_1.iterateAsync)(this.onRequestParseHooks, (onRequestParse, endEarly) => (0, promise_helpers_1.handleMaybePromise)(() => onRequestParse({
            request,
            url,
            requestParser,
            serverContext,
            ...
            return (0, promise_helpers_1.handleMaybePromise)(() => requestParser(request), requestParserFnResult => {
                if ((0, is_response_js_1.isResponse)(requestParserFnResult)) {
                    return {
    ...
    handle = (request, serverContext) => {
        ...
        return (0, promise_helpers_1.unfakePromise)((0, promise_helpers_1.fakePromise)()
            ...
            return (0, promise_helpers_1.handleMaybePromise)(() => (Array.isArray(requestParserResult)
                ? Promise.all(requestParserResult.map(params => (0, promise_helpers_1.fakePromise)()
                    .then(() => getResultForParams({
                    params,
                    request,
